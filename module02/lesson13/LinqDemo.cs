namespace Module02.Lesson13.Demo
{
	// LinqDemo.cs (Teaching Version - Step-by-Step)
	// Focus: filter (Where), order (OrderByDescending), project (Select)
	// Use this minimal walkthrough in class; save grouping and other ops for the guided exercise.
